...
class IntroView(arcade.View):
    ...
    def on_draw(self):
        ...
        arcade.draw_text("Use space to fire your ship's gun", parameters.SCREEN_WIDTH/2, parameters.SCREEN_HEIGHT-340, arcade.color.WHITE, 20, anchor_x="center")
        ...
        arcade.draw_text("Press any key to start", parameters.SCREEN_WIDTH/2, parameters.SCREEN_HEIGHT/2-520, arcade.color.WHITE, 20, anchor_x="center")
